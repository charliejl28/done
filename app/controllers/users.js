            ...
            if (!err){
                ...
                for (var i = 0; i < contactEmails.length; i++){
                    ...
                    var mailOptions = {
                        ...
                        html: '<body>
    <p style="text-align: center; font-family: \'Avant Garde\', Avantgarde, \'Century Gothic\', CenturyGothic, AppleGothic, sans-serif;">  

        <span style="font-size: 30px; color:#808080;">
            ' + req.user.name + ' has invited you to "' + event.name + '"
        </span>

        <br/><br/>

        <a style="font-size:20px;" href="' + link + '">Let me find a good time for both of you.</a>
    </p>
</body>' // html body
                    };
